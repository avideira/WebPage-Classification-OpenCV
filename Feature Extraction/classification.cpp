...
int WebPageTopic( int TrainingImages, int TestingImages )
{
	...
	*/
	...
	while(1){
		...
		case 1:
			if(MULTI_CLASS == 4)
				NaiveBayesClassifier(PathTrain_final, PathTest_final, MULTI_CLASS, MultiClass4, TrainingImages , TestingImages, FeaturesToClassifier );
			else
				NaiveBayesClassifier(PathTrain_final, PathTest_final, MULTI_CLASS, MultiClass8, TrainingImages , TestingImages, FeaturesToClassifier );
			break;
		case 2:
			if(MULTI_CLASS == 4)
				SVMClassifier(PathTrain_final, PathTest_final, MULTI_CLASS, MultiClass4, TrainingImages , TestingImages, FeaturesToClassifier );			
			else
				SVMClassifier(PathTrain_final, PathTest_final, MULTI_CLASS, MultiClass8, TrainingImages , TestingImages, FeaturesToClassifier );			

			break;
		case 3:
			if(MULTI_CLASS == 4)
				DecisionTreeClassifier(PathTrain_final, PathTest_final, MULTI_CLASS, MultiClass4, TrainingImages , TestingImages, FeaturesToClassifier );		
			else
				DecisionTreeClassifier(PathTrain_final, PathTest_final, MULTI_CLASS, MultiClass8, TrainingImages , TestingImages, FeaturesToClassifier );		
		
			break;
		case 4:
			if(MULTI_CLASS == 4)
				BoostClassifierMulti(PathTrain_final, PathTest_final, MULTI_CLASS, MultiClass4, TrainingImages, TestingImages, FeaturesToClassifier );
			else
				BoostClassifierMulti(PathTrain_final, PathTest_final, MULTI_CLASS, MultiClass8, TrainingImages, TestingImages, FeaturesToClassifier );
...
int WebPageRecency( int TrainingImages, int TestingImages )
{
	...
	*/
	...
	while(1){
		...
		{
		case 1:
			NaiveBayesClassifier(PathTrain_final, PathTest_final, BINARY_CLASS, BinaryClass, TrainingImages, TestingImages , NumberOfFeats);
			break;
		case 2:
			SVMClassifier(PathTrain_final, PathTest_final, BINARY_CLASS, BinaryClass, TrainingImages , TestingImages , NumberOfFeats);
			break;
		case 3:
			DecisionTreeClassifier(PathTrain_final, PathTest_final, BINARY_CLASS, BinaryClass, TrainingImages, TestingImages , NumberOfFeats);
			break;
		case 4:
			BoostClassifierBinary(PathTrain_final, PathTest_final, BINARY_CLASS, BinaryClass, TrainingImages , TestingImages , NumberOfFeats);
			break;
		default:
			cout << "You have entered an invalid choice.\n"
				 << "Please try again.\n\n";
